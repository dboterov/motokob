...
app.use((req, res, next) => {
  ...
  res.header('Access-Control-Allow-Headers', 'Authorization, X-API-KEY, Origin, X-Requested-With, Content-Type, Accept, Access-Allow-Request-Method, X-Selected-Company');
